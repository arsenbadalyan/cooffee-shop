...
import HeroImage from "../../../public/assets/cooffee-hero.jpg";
import CoffeeCupsImage from "../../../public/assets/cooffee-cups.jpg";
        ...
        <div className={styles.aboutCardContainer}>
          ...
          <div className={styles.aboutTextContainer}>
            ...
            <div className={styles.aboutBodyText}>
              <p>
                The COOFFEE shop was not always like this. It used to be a
